#!/usr/bin/env python3
"""
Gmail OAuth2 Setup Script for n8n - Fixed Version
Script thiết lập OAuth2 cho Gmail API trong n8n - đã sửa lỗi scope
"""
...
def setup_gmail_oauth():
    ...
    print("🔧 Gmail OAuth2 Setup for n8n (Fixed Version)")
    print("=" * 50)

#!/usr/bin/env python3
"""
Gmail OAuth2 Setup Script for n8n - Full Scopes Version
Script thiết lập OAuth2 cho Gmail API trong n8n - với đầy đủ scope
"""
...
def setup_gmail_oauth():
    ...
    print("🔧 Gmail OAuth2 Setup for n8n (Full Scopes Version)")
    print("=" * 50)
    ...
    # Create OAuth flow with all scopes that were added in OAuth consent screen
